...
def un_plural(string,target):
    return string.replace(f'{target}s',target)
...
def replace_units_to_un_plural(string):
    string = un_plural(string,'input_time_unit')
    string = un_plural(string,'input_dist_unit')
    string = un_plural(string,'output_time_unit')
    return un_plural(string,'output_dist_unit')
...
for file in files:
    try:
        ...
        contents = replace_units_to_un_plural(contents)

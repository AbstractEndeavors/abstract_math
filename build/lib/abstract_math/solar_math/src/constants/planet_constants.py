...
# -------------------------
def hill_radius(planet: str = "earth", dist_unit: str = "meters") -> float:
    ...
    return dconvert(r_m, "meters", normalize_distance_unit(dist_unit))

def soi_radius(planet: str = "earth", dist_unit: str = "meters") -> float:
...
def gravity_reach(planet: str = "earth", a_threshold: float = 1e-6, dist_unit: str = "meters") -> float:
    """
